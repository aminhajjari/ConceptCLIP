...
# Check if quick_download_conceptclip exists
try:
    from .quick_download_conceptclip import quick_download
    CONCEPTCLIP_DOWNLOADER_AVAILABLE = True
except ImportError:
    CONCEPTCLIP_DOWNLOADER_AVAILABLE = False
    quick_download = None
...
__all__ = [
    ...
    'quick_download',  # Add this
    'CONCEPTCLIP_DOWNLOADER_AVAILABLE'  # Add this
]